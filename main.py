...
lan_list = ["eng", "fr", "de", "tr"]
lan1 = input(f"Enter source language code {lan_list} : ")
lan_list.remove(lan1)
lan2 = input(f"Enter translating language code {lan_list} : ")
...
language_info = canvas.create_text(400, 150, text=f"{lan1}", fill="black", font=("Ariel", 40, "italic"))
word = canvas.create_text(400, 263, text=card[f"{lan1}"], fill="black", font=("Ariel", 60, "bold"))
